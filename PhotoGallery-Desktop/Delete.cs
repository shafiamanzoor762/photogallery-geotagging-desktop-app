...
namespace PhotoGallery_Desktop
{
    public partial class Delete : Form
    {
            ...
            private async void btnokay_Click(object sender, EventArgs e)
            {
                ...
                // User wants to delete the image
                MessageBox.Show("Deleting metadata...");
                bool result = await Logic.DeleteImageMetadata(id.ToString());
                MessageBox.Show(result ? "Metadata deleted successfully." : "Failed to delete the image metadata.");
            }
                else
                {
